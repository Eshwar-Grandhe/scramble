...
public void actionPerformed(ActionEvent e)
{
    ...
    thelp.setText("When Playing Word Building, Anywhere From Two To Six Players Will Enjoy The Game. The Object When Playing Is To Score More Points Than Other Players. "+"\n"
        ...
        f2.setBounds(0,0,1440,1080);
        f2.setSize(1440,1080);
        f2.setLayout(null);
        f2.setVisible(true);
    }
    if((e.getSource())==back)
    ...
    if((e.getSource())==np)
    {
        ...
        if(n>6||n<2)
        {
            l7.setText("<html>Maximum No.of Players Are 6 <br>And Minimum is 2, Enter Again</html>");
    ...
    if((e.getSource())==start)
    {
        ...
        if(n==3)
        {
            f2.add(l1); f2.add(l2);f2.add(l3);
            f2.add(la); f2.add(lb); f2.add(lc);
        ...
        if(n==4)
        {
            ...
            f2.add(la); f2.add(lb); f2.add(lc); f2.add(ld);
        ...
        if(n==5)
        {
            ...
            f2.add(la); f2.add(lb); f2.add(lc); f2.add(ld); f2.add(le);
        ...
        if(n==6)
        {
            ...
            f2.add(la); f2.add(lb); f2.add(lc); f2.add(ld); f2.add(le); f2.add(lf);
...
public boolean search(String s)
{
    if(s.charAt(0)=='a')
    {
        if(s.length()==1)
        {
            String a2[]= {"a","aa","ab","ad","ae","ag","ah","ai","al","am","an","ar","as","at","aw","ax","ay"};
